...
def init_db() -> None:
    ...
    if engine.dialect.name == "sqlite":
        additions = {"contracts": [("accepted_at", "DATETIME"), ("pdf_hash", "VARCHAR(64)"), ("gatekeeper_project_id", "VARCHAR(64)"), ("archived_at", "DATETIME"), ("idempotency_key", "VARCHAR(128)")],
                     "invoices": [("client_email", "VARCHAR(255)"), ("paid_at", "DATETIME"), ("pdf_hash", "VARCHAR(64)"), ("archived_at", "DATETIME"), ("idempotency_key", "VARCHAR(128)")]}
